...
#elif PAGES == 128
#warning Setting pages to 128
#elif PAGES == 64
#warning Setting pages to 64
#else
#error Unexpected PAGES value
#endif
...
#include <assert.h>
static_assert(sizeof(flash_memory_st) == (PAGES)*2*1024, "Data structure doesn't match flash size");
